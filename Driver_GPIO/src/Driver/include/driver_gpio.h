...
#define Driver_GPIOA Driver_GPIO0
#define Driver_GPIOB Driver_GPIO0
#define Driver_GPIOC Driver_GPIO0
#define Driver_GPIOD Driver_GPIO0
#define Driver_GPIOE Driver_GPIO0

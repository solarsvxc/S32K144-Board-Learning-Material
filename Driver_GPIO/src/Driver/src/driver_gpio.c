    ...
    if (PIN_IS_AVAILABLE(pin)) 
    {
        switch (trigger) 
        {
            case ARM_GPIO_TRIGGER_NONE:
                HAL_GPIO_Trigger_Event(pin,ARM_GPIO_TRIGGER_NONE);
                break;
            case ARM_GPIO_TRIGGER_RISING_EDGE:
                HAL_GPIO_Trigger_Event(pin,ARM_GPIO_TRIGGER_RISING_EDGE);
                break;
            case ARM_GPIO_TRIGGER_FALLING_EDGE:
                HAL_GPIO_Trigger_Event(pin,ARM_GPIO_TRIGGER_FALLING_EDGE);
                break;
            case ARM_GPIO_TRIGGER_EITHER_EDGE:
                HAL_GPIO_Trigger_Event(pin,ARM_GPIO_TRIGGER_EITHER_EDGE);
                break;
            default:
                result = ARM_DRIVER_ERROR_PARAMETER;
                break;
